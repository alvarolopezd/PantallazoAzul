...
void Escobas::SetObjetos()
{
	...
	cil1.SetAtributos((GetXPosicion() + 5.25), GetYPosicion(), 5.25, 5.25, 5.6, 50, 50, 150, 150, 0);
	cil2.SetAtributos(GetXPosicion()+5.25, (GetYPosicion() + 5.6), 5.25, 5.25, 2.7, 50, 50, 64, 32, 0);
}
